...
contract BettingGame is VRFConsumerBase {
   ...
   */
   ...
   /* está utilizando o aggregator interface para pegar
   o preço eth/usd Declara uma variável do tipo Aggre...
   */
  ...
  constructor() VRFConsumerBase(VFRC_address, LINK_address) public {
     ...
     */
     // instancia a variável do tipo aggregator
   ...
   */
   ...
   // aqui é para o usuário iniciar o jogo
   // tem que enviar ether
   ...
   */
   /*  passa o número vindo do oracle para essa função
   e se o jogador acertou paga o dobro de sua aposta.
   */
